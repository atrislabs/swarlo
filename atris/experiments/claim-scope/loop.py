"""Keep/revert loop for the Swarlo claim-scope experiment."""
...
DEFAULT_TARGET = REPO_ROOT / "swarlo" / "sqlite_backend.py"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the Swarlo claim-scope keep/revert loop.")
