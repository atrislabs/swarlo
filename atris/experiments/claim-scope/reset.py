"""Restore the Swarlo claim-scope target to baseline."""
...
BASELINE_METHODS = '''    async def claim(self, hub_id: str, member: Member, channel: str,
...
TARGET.write_text(text[:start] + BASELINE_METHODS + text[end:], encoding="utf-8")

print("reset claim-scope target to baseline")
